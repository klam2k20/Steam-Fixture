...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def stop_function(self):
        ...
        if self.dataframe_Empty_Check():
            ...
            self.ui.final_water_mass_line.setValidator(self.double_validator)
            self.ui.final_water_mass_line.textChanged.connect(self.final_water_mass_line.check_state)
            self.ui.final_water_mass_line.textChanged.emit(self.final_water_mass_line.text())
            ...
            self.ui.final_food_mass_line.setValidator(self.double_validator)
            self.ui.final_food_mass_line.textChanged.connect(self.final_food_mass_line.check_state)
            self.ui.final_food_mass_line.textChanged.emit(self.final_food_mass_line.text())
            self.ui.final_food_mass_line.textChanged.connect(self.enable_resume)
            self.ui.final_food_mass_line.setStatusTip('Input final water mass')
