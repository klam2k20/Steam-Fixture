...
class steamSensorFixture():
    ...
    # Creates a RAW DATA folder & Date folder to hold the logged sensor data.
    ...
    def update_Dataframe(self, updated_time, ADC_Value):
        ...
        if constants.START_TIME != 0:
            new_row = {'Time (min)':updated_time, 
                    ...
                    'Steam Temp. (C)':self.read_temp(constants.TEMP_PROBE_STEAM), 'Surrounding Temp. (C)':self.read_temp(constants.TEMP_PROBE_SURR)}
...
class GraphWindow(QtWidgets.QWidget):
    ...
    def humidity_Graph(self, sc, time, humidity1, humidity2, humidity3):
    ...
    def graph(self):
        ...
        self.humidity_Graph(sc, time, humidity1, humidity2, humidity3)
